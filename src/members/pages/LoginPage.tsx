...
export const LoginPage = (props: React.PropsWithChildren) => {
    return <Page>
      ...
      wieviele Anteile Du übernehmen willst.
        ...
        <ButtonLink style="primary" href="/anmelden/?action=register">Zum Registrieren geht's hier lang.</ButtonLink>
        <br/>
        <p>
      Wenn Du dich schon registriert hast, melde dich bitte erst an:
        </p>
        <ButtonLink style="primary" href="/anmelden/?redirect_to=/mitgliedsantrag">Login</ButtonLink>
        <br/>
        <p>
       ...oder stell dein Passwort wieder her, falls Du es vergessen hast:
        </p>
        <ButtonLink style="primary" href="/anmelden/?action=lostpassword">Ich habe mein Passwort vergessen.</ButtonLink>
    </Page>;
};